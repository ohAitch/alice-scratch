...
class PrototypeAST { /// PrototypeAST - This class represents the "prototype" for a function, which captures its argument names as well as if it is an operator.
	std::string Name;
...
static ExprAST *ParseNumberExpr() { /// numberexpr ::= number
...
static ExprAST *ParseExpression() { /// expression ::= unary binoprhs
