...
public abstract class S
{
	...
	public static <E> ArrayList<E> newList() {return new ArrayList<E>();}
	public static <E> void addToList(List<E> list, E element, int count) {for (int i = 0; i < count; i++) list.add(element);}
	public static Scanner getScanner() {return new Scanner(System.in);}
//}
//============================================================// maths //============================================================//
//{
	/*private static int upToPowOf2(int i) {
		i--;
		i |= i >> 1;
		i |= i >> 2;
		i |= i >> 4;
	...
	public static int floor(double d) {
		...
		if (exponent >= 52) return (int)d;
		if ((Double.doubleToRawLongBits(d) & (0x000FFFFFFFFFFFFFL >> exponent)) == 0L) return (int)d; //a is an integral value
		return (int)d - 1;
	}
	...
	public static int mod(int a, int b) {return b == 0? 0 : a >= 0? a%b : (a%b + b) % b;}
	public static double mod(double a, double b) {a %= b; if (a < 0) a += b; return a;}
...
//{
	...
	public static int rand(int i) {return rand.nextInt(i);}
	/**a and b are inclusive*/ public static int rand(int a, int b) {return rand.nextInt(b - a + 1) + a;}
	/**a and b are inclusive*/ public static double rand(double a, double b) {return rand.nextDouble() * (b - a) + a;}
	...
	public static  <T>  T rand(     T... a) {return a[rand.nextInt(a.length)];}
	public static     int rand(    int[] a) {return a[rand.nextInt(a.length)];}
	public static    byte rand(   byte[] a) {return a[rand.nextInt(a.length)];}
	public static    char rand(   char[] a) {return a[rand.nextInt(a.length)];}
	public static    long rand(   long[] a) {return a[rand.nextInt(a.length)];}
	public static   float rand(  float[] a) {return a[rand.nextInt(a.length)];}
	public static   short rand(  short[] a) {return a[rand.nextInt(a.length)];}
	public static  double rand( double[] a) {return a[rand.nextInt(a.length)];}
	public static boolean rand(boolean[] a) {return a[rand.nextInt(a.length)];}
//}
//============================================================// strings & print //============================================================//
//{
	...
	public static String repeat(String s, int count) {
		...
		if (count <= 0) return "";
		int len = s.length();
		if (count == 1 || len == 0) return s;
		if (len == 1) {
			char[] ret = new char[count];
			for (int i = 0; i < ret.length; i++) ret[i] = s.charAt(0);
			return new String(ret);
		}
		if (len == 2) {
			char ch0 = s.charAt(0);
			char ch1 = s.charAt(1);
			char[] ret = new char[2 * count];
			for (int i = count * 2 - 2; i >= 0; i--, i--)
				{ret[i] = ch0; ret[i+1] = ch1;}
			return new String(ret);
		} else {
