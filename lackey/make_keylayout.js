...
var xml = builder.create(
	{keyboard:{
		...
		keyMapSet:{'@id':'ANSI','#list':[
			...
			].map(function(o,i){return {keyMap:{'@index':i, '#list':seq(o).map(function(kv){var t = {'@code':kv[0]}; if (!(kv[1] instanceof Array)) t['@output'] = '&#x'+hex(typeof(kv[1])==='string'? kv[1].charCodeAt(0) : kv[1],4)+';'; else t['@action'] = kv[1][0]; return {key:t}})}}})
		},
...
fs('~/Library/Keyboard Layouts/lackey.keylayout').$ = xml