...
class NiceUrlCommand(sublime_plugin.TextCommand):
	def run(self,edit):
		...
		for reg in view.sel():
			...
			v = re.sub(r'^https?(://docs\.google\.com/document/d/[\w_]+)/edit','http\\1',v)
			v = re.sub(r'^https?://(?:www\.)?facebook\.com/(\w+)(?:\?fref=nf)?','http://fb.com/\\1',v)
			v = re.sub(r'^https?://mail\.google\.com/mail/u/0/\??#(?:inbox|label/\w+)/(\w+)','http://google.com/mail/#all/\\1',v)
...
# http://www.amazon.com/Lower-Your-Taxes-Time-2013-2014/dp/0071803408/ref=sr_1_1?s=books&ie=UTF8&qid=1365921208&sr=1-1&keywords=Lower+Your+Taxes%3ABig+Time
...
# https://mail.google.com/mail/u/0/#search/working+with+or+volunteering+for+giv/1471d4aa606b592f
